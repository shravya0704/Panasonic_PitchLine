...
export const drawCurveDataInfoPage = (doc: jsPDF): void => {
  ...
  const text = [
    "Data distribution for curved LED displays is engineered using",
    "module-level routing rather than cabinet-level routing.",
    "",
    "Since signal routing depends on the final display geometry, module",
    "arrangement and installation conditions, a standard cabinet-",
    "based data flow diagram cannot accurately represent the",
    "final installation.",
    "",
    "Detailed data routing drawings are prepared by Panasonic",
