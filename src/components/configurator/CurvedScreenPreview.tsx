        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "flex-end", gap: "20px" }}>
          <div style={{ position: "relative", width: screenWidthPx + marginLeft + marginRight, height: screenHeightPx + marginTop + marginBottom, background: "#F8FAFC" }}>
            ...
            <div style={{
              ...
              backgroundImage: "linear-gradient(to bottom, rgba(255,255,255,.08), rgba(0,0,0,.06))",
              overflow: "hidden",
              border: "2px solid #CBD5E1",
              borderTopLeftRadius: "280px 55px",
              borderTopRightRadius: "300px 70px",
              borderBottomLeftRadius: "300px 70px",
              borderBottomRightRadius: "300px 70px",
              boxShadow: "0 14px 34px rgba(15,23,42,.18), inset 0 0 18px rgba(255,255,255,.08)",
            }}>
            ...
            <div style={{
              ...
              {isCurved && (
                <>
                  ...
                  <div style={{ fontSize: 12, color: "#0055A5", fontWeight: 700 }}>
                    Curved Display
                  </div>
