...
const ViewingDistanceVisualizer: React.FC<ViewingDistanceVisualizerProps> = ({
    ...
    // Base canvas reference layout metrics
    const baseCanvasWidth = 1000;
    const baseCanvasHeight = 360;

    // Dynamic Viewport Calculation for Resolution Independence
    const viewportWidth = typeof window !== "undefined" ? window.innerWidth : baseCanvasWidth;
    // Account for card padding (48px) and generic page edge cushions
    const responsiveScale = Math.min(1, (viewportWidth - 80) / baseCanvasWidth);
    ...
    return (
        <div style={cardStyle}>
            ...
            {/* ======================================================
               ...
               Ensures full container width allocation and centers the vector assets
               ====================================================== */}
            <div
                style={{
                    width: "100%",
            ...
            >
                {/* ======================================================
                   INNER SCALED BOUNDS
                   Transforms the complete CAD drawing component smoothly as a single unit
                   ====================================================== */}
                <div
                    style={{
                        position: "relative",
                        ...
                        // Eliminates trailing visual blank spaces left over by layout scale down contractions
                        marginBottom: -baseCanvasHeight * (1 - responsiveScale),
